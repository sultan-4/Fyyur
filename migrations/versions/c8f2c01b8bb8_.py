...
Revision ID: c8f2c01b8bb8
Revises: 07ce99d10036
Create Date: 2022-06-16 18:50:58.694224
...
revision = 'c8f2c01b8bb8'
down_revision = '07ce99d10036'
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('Shows', sa.Column('show_id', sa.INTEGER(), autoincrement=False, nullable=True))
    op.drop_constraint(None, 'Shows', type_='foreignkey')
    op.create_foreign_key('Shows_show_id_fkey', 'Shows', 'Artist', ['show_id'], ['id'])
